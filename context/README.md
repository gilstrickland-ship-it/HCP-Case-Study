...
- **`hcp-research/`** — background on Housecall Pro as a company and platform
  ...
  cited, confidence-labeled claims.
- **`design-system/`** — a web-based design system (CSS tokens + components +
  preview) that makes the prototype look and feel native to the HCP app. Tokens
  were extracted from the live logged-in app; `reference/` holds the source
  screenshots.

The prototype (when built) imports the design system from
